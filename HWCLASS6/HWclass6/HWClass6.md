...
- [original for A (can you improve this analysis
  code?)](#original-for-a-can-you-improve-this-analysis-code)
- [improved version of A)](#improved-version-of-a)
- [original for B (can you improve this analysis
  code?)](#original-for-b-can-you-improve-this-analysis-code)
- [improved version of B)](#improved-version-of-b)
- [Q6. How would you generalize the original code above to work with any
  set of input orotein
  structures](#q6-how-would-you-generalize-the-original-code-above-to-work-with-any-set-of-input-orotein-structures)
...
![](HWClass6_files/figure-commonmark/unnamed-chunk-3-1.png)

``` r
plotb3(s2.b, sse=s2.chainA, typ="l", ylab="Bfactor")
```

![](HWClass6_files/figure-commonmark/unnamed-chunk-3-2.png)

``` r
plotb3(s3.b, sse=s3.chainA, typ="l", ylab="Bfactor")
```

![](HWClass6_files/figure-commonmark/unnamed-chunk-3-3.png)
...
```
    ...
    C:\Users\kenny\AppData\Local\Temp\RtmpYVw1m8/4AKE.pdb exists. Skipping download

      Note: Accessing on-line PDB file

    Warning in get.pdb(file, path = tempdir(), verbose = FALSE):
    C:\Users\kenny\AppData\Local\Temp\RtmpYVw1m8/1AKE.pdb exists. Skipping download

       PDB has ALT records, taking A only, rm.alt=TRUE
      Note: Accessing on-line PDB file

    Warning in get.pdb(file, path = tempdir(), verbose = FALSE):
    C:\Users\kenny\AppData\Local\Temp\RtmpYVw1m8/1E4Y.pdb exists. Skipping download
...
![](HWClass6_files/figure-commonmark/unnamed-chunk-4-1.png)
...
![](HWClass6_files/figure-commonmark/unnamed-chunk-5-1.png)
